...
<body style="padding: 0; margin: 0;background:#6699FF;">
	<div>
		<center>
		<br>
		<h2><font color="blue">新闻信息中心</font>  </h2>
		<br />
		<br />
	...
	%>
			...
			<table width="95%" border="1" bordercolor="#000000">
				<tr>
					<td width="200" height="25" >新闻主题</td>
					<td width="400" height="25" >新闻内容</td>
				</tr>
			...
			int count = 0;
				...
				for(int j=0; j<lineSize;j++) {		
					if(rs.next()) 
						...
						note.setNewsinfo(rs.getString(3)) ;
	...
	<%
										...
										while(iter.hasNext())
										{
											...
											String newsinfo = note.getNewsinfo();
											
									%>
	
				<tr>
					<td height="30"><%= title %></td>
					<td height="30"><%=newsinfo %></td>
				</tr>
				<%
						}
